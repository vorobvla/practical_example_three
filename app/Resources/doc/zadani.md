...
**FIXME**: memory/db implementace služeb nebo oboje? 
...
**FIXME**: Automatické vyhodnocení bude spuštěno **FIXME**. **FIXME**. 2015 v 0.00, aby bylo možné na cvičeních hodnocení uzavřít.
